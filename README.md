...
--- | --- | ---
[fieldservice](fieldservice/) | 12.0.2.4.2 | Manage Field Service Locations, Workers and Orders
...
[fieldservice_route](fieldservice_route/) | 12.0.2.1.0 | Organize the routes of each day.
[fieldservice_route_account](fieldservice_route_account/) | 12.0.1.0.0 | Field Service Route Account
[fieldservice_route_stock](fieldservice_route_stock/) | 12.0.1.2.0 | Field Service Route Stock
[fieldservice_route_vehicle](fieldservice_route_vehicle/) | 12.0.2.1.0 | This module allows you to set the vehicle on the routes and day routes.
