...
class FSMOrder(models.Model):
    ...
    def prepare_dayroute_values(self, values):
        ...
        res.update({"fsm_vehicle_id": values["vehicle_id"]})
        return res
        ...
        res.update(
            {
                ...
                or self.vehicle_id.id
                or self.fsm_route_id.fsm_vehicle_id.id
            }
        )
        return res
    ...
    def create(self, vals):
        if not vals.get("vehicle_id", False):
            ...
            vals.update({"vehicle_id": location.fsm_route_id.fsm_vehicle_id.id})
