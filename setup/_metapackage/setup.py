...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-fieldservice_kanban_info_route>=15.0dev,<15.1dev',
        ...
        'odoo-addon-fieldservice_sale_stock_product_tags>=15.0dev,<15.1dev',
        ...
        'odoo-addon-fieldservice_vehicle_stock>=15.0dev,<15.1dev',
        'odoo-addon-fieldservice_website_sale>=15.0dev,<15.1dev',
        'odoo-addon-fieldservice_website_sale_extra_step>=15.0dev,<15.1dev',
    ],
    classifiers=[
