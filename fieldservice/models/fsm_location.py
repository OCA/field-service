...
class FSMLocation(models.Model):
    ...
    fsm_person_id = fields.Many2one(string='Primary Assignment', related='sales_territory_id.fsm_person_id')
    district_manager = fields.Many2one(string='District Manager', related='district_id.partner_id')
    region_manager = fields.Many2one(string='Region Manager', related='region_id.partner_id')
    branch_manager = fields.Many2one(string='Branch Manager', related='branch_id.partner_id')
    ...
    inventory_location = fields.Many2one('stock.location', string='Location Designation')
    ...
    preferred_workers = fields.Many2many('fsm.person', 'partner_id', string='Preferred People')
