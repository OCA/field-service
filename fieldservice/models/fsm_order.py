...
class FSMOrder(models.Model):
    ...
    # Odoo 19 core no longer exposes a dedicated mobile on locations/partners
    # so we mirror the main phone to avoid invalid related targets.
    mobile = fields.Char(related="location_id.phone", string="Mobile")
