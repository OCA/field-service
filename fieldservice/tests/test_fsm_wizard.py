...
class FieldServiceTransactionCase(TransactionCase):
    ...
    def setUp(self):
        ...
        - test_convert_location: tests that a res.partner can be converted into a 
        fsm.location.
        - test_convert_person: tests that a res.partner can be converted into a 
        fsm.person.
        - test_convert_sublocation: tests that the sub-contacts on a res.partner
        are converted into Other Addresses.
        """
        ...
        #create expected FSM Location to be compared to converted FSM Location
        ...
        #create expected FSM Person to be compared to converted FSM Person
    ...
    def test_convert_location(self):
        ...
        self.wiz_location = self.env['fsm.location'].search([('name', '=', 'Test Partner')])
