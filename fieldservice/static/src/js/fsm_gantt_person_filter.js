odoo.define("fsm_gantt.person_filter", function(require) {
    ...
    TimelineRenderer.include({
        ...
        do_search: function(domains, contexts, group_bys) {
            ...
            fields = _.uniq(
                fields.concat(_.pluck(this.colors, "field").concat(n_group_bys))
            );
            return this._rpc({
         ...
         * @returns Array
         */
        do_search_related_user_filter: function(
            domains,
            contexts,
            group_bys,
            user_ids
        ...
        on_user_data_loaded: function(events, group_bys, adjust_window, user_ids) {
            ...
            return this._rpc({
                ...
                return self.on_user_data_loaded_2(
                    nevents,
                    group_bys,
                    adjust_window,
                    user_ids
        ...
        apply_clear_user_filter: function(clear) {
            ...
            if (clear) {
                ...
                var domain =
                    filters[0] && filters[0].attrs && filters[0].attrs.domain
                        ? filters[0].attrs.domain
                        : false;
                ...
                if (domain) {
                    this._rpc({
                        ...
                        self.do_search_related_user_filter(
                            temp_domain,
                            self.last_contexts,
                            self.last_group_bys,
                            list_user_ids
        ...
        start: function() {
            ...
            this.$el
                .find(".oe_timeline_button_apply")
                .click($.proxy(this.on_apply_clicked, this));
            this.$el
                .find(".oe_timeline_button_clear")
                .click($.proxy(this.on_clear_clicked, this));
