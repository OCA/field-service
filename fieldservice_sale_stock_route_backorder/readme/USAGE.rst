...
3. Add a product that generates an FSM order (Field Service Tracking set to "Create one FSM order per sale order" on the product form). If you want this product to generate a backorder sale whenever it is not fully delivered, ensure the field **Create Backorder Sale Order** is checked on the product form
