...
class FSMPartialDeliveryWizard(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        sale_lines = sale_order.order_line.filtered(
            lambda l: l.product_id.product_tmpl_id.field_service_tracking == "sale"
            ...
            if line.sale_line_id:
                ...
                if (
                    ...
                    price_unit = pricelist.get_product_price(
                        product, undelivered_qty, partner
                    )
        ...
        for line in self.sale_line_ids:
            ...
            if pricelist:
                price = pricelist.get_product_price(
                    line.product_id, line.quantity_done, order.partner_id
                )
