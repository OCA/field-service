=================================
Field Service - Maintenance Stock
=================================
...
Odoo Maintenance Equipment does not have a Product or a Serial Number. When 
Field Service Stock is installed, FSM Equipment has a Product and a Serial Number, 
this modules adds the same to a Maintenance Equipment and adjusts the create() in FSM Equipment 
and the Maintenance Equipment Wizard accordingly.
...
When installing fieldservice_maintenance_stock you must have fieldservice_maintenance and 
fieldservice_maintenance_stock.
...
* Create an FSM Equipment with a Product and Serial Number
* Observe Maintenance Equipment made with same Product and Serial Number
* Verify link between Equipments is set
